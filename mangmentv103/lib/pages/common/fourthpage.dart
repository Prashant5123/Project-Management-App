...
class _FourthPageState extends State<FourthPage> {
  ...
  Widget build(BuildContext context) {
    ...
    String useranme = " ${loginprovider.userdata!.name}";
            ...
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    "Name: ${loginprovider.userdata!.name}",
                ...
                Padding(
                  padding: EdgeInsets.symmetric(vertical: 8.0),
                  child: Text(
                    "Email id: ${loginprovider.userdata!.email}",
                    style: TextStyle(fontSize: 18),
                  ),
                ),
                Padding(
                  padding: EdgeInsets.symmetric(vertical: 8.0),
                  child: Text(
                    "Designation: ${loginprovider.userdata != null ? _getDesignation(loginprovider.userdata!.designation) : 'Error: 101'}",
                    style: TextStyle(fontSize: 18),
                  ),
                ),
                Padding(
                  padding: EdgeInsets.symmetric(vertical: 8.0),
                  child: Text(
                    "Employee ID : ${loginprovider.userdata!.empid}",
                    style: TextStyle(fontSize: 18),
                  ),
                ),
                Padding(
